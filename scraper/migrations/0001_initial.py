# Generated by Django 3.1.1 on 2021-03-13 17:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spider_data', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('crawlers', models.ManyToManyField(to='scraper.SpiderCrawler')),
            ],
        ),
        migrations.CreateModel(
            name='Scraper',
            fields=[
                ...
                ('spiders', models.ManyToManyField(to='scraper.Spider')),
